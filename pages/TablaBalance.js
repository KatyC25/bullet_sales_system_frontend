...
function TablaBalance(props) {
    ...
    return (
        <div className="flex flex-col w-full xl:flex-row">
            ...
            <div>
                <div className="bg-yellow-100 font-serif px-3 py-1 border border-gray-100 text-gray-800  text-center  ">Balance General</div>
                <div className=" bg-yellow-100 font-serif  px-3 py-1 border border-gray-100 text-gray-800 text-center  ">Empresa "{datosEmpresa.nombre}"</div>
                <div className=" bg-yellow-100 font-serif px-3 py-1 border border-gray-100 text-gray-800 text-center "> {datosEmpresa.periodo}</div>
                ...
                <table className="flex-1 table w-full text-center bg-white border-separate">
                    ...
                    <tbody>
                        ...
                        <tr className="bg-yellow-300 font-serif"  >
                        ...
                        <tr className="bg-yellow-200  font-serif">
                        ...
                        <tr className="bg-yellow-100 font-normal">
                        ...
                        <tr className="bg-yellow-100">
                            ...
                            <td className="px-3 py-1 border border-gray-200">{datosEmpresa.caja + datosEmpresa.banco +
                                datosEmpresa.mercancias + datosEmpresa.documentos + datosEmpresa.deudores} </td>
                            <td className="px-3 py-1 border border-gray-200"> </td>
                        </tr>
                        <tr className="bg-yellow-200 font-serif">
                        ...
                        <tr className="bg-yellow-100">
                            ...
                            <td className="px-3 py-1 border border-gray-200">{datosEmpresa.edificio + datosEmpresa.mobiliarioE + datosEmpresa.depositos} </td>
                            <td className="px-3 py-1 border border-gray-200"> </td>
                        </tr>
                        <tr className="bg-yellow-200 font-serif">
                        ...
                        <tr className="bg-yellow-100">
                            ...
                            <td className="px-3 py-1 border border-gray-200">{datosEmpresa.GastosdeInstalacion + datosEmpresa.papeleria} </td>
                            <td className="px-3 py-1 border border-gray-200"> </td>
                        ...
                        <tr className="bg-yellow-300 font-serif">
                            ...
                            <td className="px-3 py-1 border border-gray-200"> </td>
                            <td className="px-3 py-1 border border-gray-200"> </td>
                            <td className="px-3 py-1 border border-gray-200">{datosEmpresa.caja + datosEmpresa.banco + datosEmpresa.mercancias + datosEmpresa.documentos + datosEmpresa.deudores +
                                datosEmpresa.edificio + datosEmpresa.mobiliarioE + datosEmpresa.depositos + datosEmpresa.GastosdeInstalacion + datosEmpresa.papeleria}</td>
                        ...
                        <tr className="bg-yellow-100">
                            ...
                            <td className="px-3 py-1 border border-gray-200">{datosEmpresa.proveedores + datosEmpresa.documentosp + datosEmpresa.acreedores} </td>
                            <td className="px-3 py-1 border border-gray-200"> </td>
                        </tr>
                        <tr className="bg-yellow-200 font-serif">
                        ...
                        <tr className="bg-yellow-300 font-serif">
                            ...
                            <td className="px-3 py-1 border border-gray-200"> </td>
                            <td className="px-3 py-1 border border-gray-200">{datosEmpresa.proveedores
                                + datosEmpresa.documentosp + datosEmpresa.acreedores + datosEmpresa.acreedoresh + datosEmpresa.rentas} </td>
                            <td className="px-3 py-1 border border-gray-200"> </td>
                        ...
                        <tr className="bg-yellow-200 font-serif">
                            ...
                            <td className="px-3 py-1 border border-gray-200"> </td>
                            <td className="px-3 py-1 border border-gray-200">{datosEmpresa.proveedores
                                + datosEmpresa.documentosp + datosEmpresa.acreedores + datosEmpresa.acreedoresh + datosEmpresa.rentas + datosEmpresa.capital} </td>
